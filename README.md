...
*29 October 2019*, [Workshop] Advanced gradient descent optimization algorithms, by [to be specified]. *Prerequisites*: Python installed, with Jupyter/VS Code/Pycharm environments.
